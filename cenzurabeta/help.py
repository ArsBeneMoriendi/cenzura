...
def load(gateway, discord):
    ...
    def help(ctx):
        ...
        fields.append({
                        "name": "\u200b",
                        "value": f"\[ [Dodaj bota](https://discord.com/api/oauth2/authorize?client_id={ctx.bot['id']}&permissions=60486&scope=bot) \] \[ [Support](https://discord.gg/kJuGceekR5) \] \[ [Kod bota](https://github.com/CZUBIX/cenzura-beta) \]",
                        "inline": False
                    })
